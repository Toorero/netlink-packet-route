...
use super::gre_common::{
    ...
    IFLA_GRE_FLAGS, IFLA_GRE_FLOWINFO, IFLA_GRE_FWMARK, IFLA_GRE_IFLAGS,
    IFLA_GRE_IKEY, IFLA_GRE_LOCAL, IFLA_GRE_OFLAGS, IFLA_GRE_OKEY,
    IFLA_GRE_REMOTE, IFLA_GRE_TTL,
};
